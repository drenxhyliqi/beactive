...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden">
      ...
      {/* Rendered statically (no JS-driven reveal) so the headline — the LCP element — paints
          immediately with the HTML instead of waiting for hydration. */}
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-28 text-center sm:py-36">
        ...
        <p className="mx-auto mt-8 max-w-xl text-sm text-text-secondary sm:text-base lg:text-lg">
          From all-hands and classrooms to conferences and workshops, beactive turns passive
          audiences into live conversations — polls, Q&amp;A, quizzes, and idea walls people join
